...
|---------------|-------------|
| [ClaudeTerminal_1.22.0_x64-setup.exe](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.22.0_x64-setup.exe) | NSIS Installer (Recommended) |
| [ClaudeTerminal_1.22.0_x64_en-US.msi](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.22.0_x64_en-US.msi) | MSI Installer |
