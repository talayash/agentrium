...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.34.5-green?style=flat-square" alt="Version">
...
|---|---|---|
| Windows | [Agentrium_1.34.5_x64-setup.exe](https://github.com/talayash/agentrium/releases/latest/download/Agentrium_1.34.5_x64-setup.exe) | NSIS Installer (Recommended) |
| Windows | [Agentrium_1.34.5_x64_en-US.msi](https://github.com/talayash/agentrium/releases/latest/download/Agentrium_1.34.5_x64_en-US.msi) | MSI Installer |
| macOS (Apple Silicon) | [Agentrium_1.34.5_aarch64.dmg](https://github.com/talayash/agentrium/releases/latest/download/Agentrium_1.34.5_aarch64.dmg) | DMG for M1/M2/M3/M4 Macs |
| macOS (Intel) | [Agentrium_1.34.5_x64.dmg](https://github.com/talayash/agentrium/releases/latest/download/Agentrium_1.34.5_x64.dmg) | DMG for Intel Macs |
