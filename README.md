...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.26.3-green?style=flat-square" alt="Version">
...
|---|---|---|
| Windows | [ClaudeTerminal_1.26.3_x64-setup.exe](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.26.3_x64-setup.exe) | NSIS Installer (Recommended) |
| Windows | [ClaudeTerminal_1.26.3_x64_en-US.msi](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.26.3_x64_en-US.msi) | MSI Installer |
| macOS (Apple Silicon) | `ClaudeTerminal_1.26.3_aarch64.dmg` | DMG for M1/M2/M3/M4 Macs |
| macOS (Intel) | `ClaudeTerminal_1.26.3_x64.dmg` | DMG for Intel Macs |
